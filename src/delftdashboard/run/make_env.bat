...
set repos_path=c:\work\checkouts\git

call conda create -n delftdashboard python=3.10

call conda activate delftdashboard
...
call pip install -e %repos_path%\cht_sfincs0
