...
import numpy as np
from cht_bathymetry.utils import add_buffer, get_isobaths
...
def push(*args):
    ...
    refinement_gdf = add_buffer(
        shoreline_gdf, buffer_land=buffer_land, buffer_sea=buffer_sea, simplify=0.0
    )
