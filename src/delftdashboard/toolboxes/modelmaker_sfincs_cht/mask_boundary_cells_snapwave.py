...
def deselect(*args):
    changed = False
    if app.toolbox["modelmaker_sfincs_cht"].open_boundary_polygon_snapwave_changed and len(app.toolbox["modelmaker_sfincs_cht"].open_boundary_polygon_snapwave) > 0:
        changed = True
    if app.toolbox["modelmaker_sfincs_cht"].neumann_boundary_polygon_snapwave_changed and len(app.toolbox["modelmaker_sfincs_cht"].neumann_boundary_polygon_snapwave) > 0:
        changed = True
    if changed:    
...
def delete_open_boundary_polygon_snapwave(*args):
    ...
    app.toolbox["modelmaker_sfincs_cht"].open_boundary_polygon_snapwave_changed = True
    update()
...
def save_open_boundary_polygon_snapwave(*args):
    ...
    app.toolbox["modelmaker_sfincs_cht"].open_boundary_polygon_snapwave_changed = False
...
def delete_neumann_boundary_polygon_snapwave(*args):
    ...
    app.toolbox["modelmaker_sfincs_cht"].neumann_boundary_polygon_snapwave_changed = True
    update()
...
def save_neumann_boundary_polygon_snapwave(*args):
    ...
    app.toolbox["modelmaker_sfincs_cht"].neumann_boundary_polygon_snapwave_changed = False
