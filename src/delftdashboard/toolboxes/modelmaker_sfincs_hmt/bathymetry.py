...
class SfincsHmtBathymetry():
    ...
    def select_bathymetry_source(self, *args):
        source = args[0]
    ...
    def select_bathymetry_dataset(self, *args):
        pass

    def info_selected_dataset(self, *args):
    ...
    def select_selected_bathymetry_dataset(self, *args):
        self.update()


    def remove_selected_bathymetry_dataset(self, *args):
    ...
    def move_up_selected_bathymetry_dataset(self, *args):
    ...
    def move_down_selected_bathymetry_dataset(self, *args):
        if len(app.toolbox["modelmaker_sfincs_hmt"].selected_bathymetry_datasets) < 2:
            return
        group = "modelmaker_sfincs_hmt"
        index = app.gui.getvar(group, "selected_bathymetry_dataset_index")
    ...
    def advanced_merge_options_bathymetry_dataset(self, *args):
        toolbox_name = "modelmaker_sfincs_hmt"
    ...
    def edit_zmax_bathymetry_dataset(self, *args):
        group = "modelmaker_sfincs_hmt"
        index = app.gui.getvar(group, "selected_bathymetry_dataset_index")
    ...
    def edit_zmin_bathymetry_dataset(self, *args):
        group = "modelmaker_sfincs_hmt"
        index = app.gui.getvar(group, "selected_bathymetry_dataset_index")
        app.toolbox["modelmaker_sfincs_hmt"].selected_bathymetry_datasets[index][
            "zmin"
    ...
    def edit_offset_bathymetry_dataset(self, *args):
        group = "modelmaker_sfincs_hmt"
        index = app.gui.getvar(group, "selected_bathymetry_dataset_index")
        app.toolbox["modelmaker_sfincs_hmt"].selected_bathymetry_datasets[index][
            "offset"
    ...
    def edit_buffer_cells_bathymetry_dataset(self, *args):
    ...
    def select_interp_method(self, *args):
    ...
    def generate_bathymetry(self, *args):
