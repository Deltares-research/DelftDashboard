...
def select(*args):
    ...
    app.map.layer["modelmaker_sfincs_hmt"].layer["open_boundary_polygon_snapwave"].activate()
    app.map.layer["modelmaker_sfincs_hmt"].layer["neumann_boundary_polygon_snapwave"].activate()
...
def delete_open_boundary_polygon_snapwave(*args):
    if len(app.toolbox["modelmaker_sfincs_hmt"].open_boundary_polygon_snapwave) == 0:
        return
    index = app.gui.getvar("modelmaker_sfincs_hmt", "open_boundary_polygon_index_snapwave")
    # Delete from map
...
def load_open_boundary_polygon_snapwave(*args):
    ...
    if not full_name:
        return
    append = False
    if app.gui.getvar("modelmaker_sfincs_hmt", "nr_open_boundary_polygons_snapwave"):
...
def select_open_boundary_polygon_snapwave(*args):
    index = args[0]
    app.map.layer["modelmaker_sfincs_hmt"].layer["open_boundary_polygon_snapwave"].activate_feature(index)
...
def draw_neumann_boundary_polygon_snapwave(*args):
    app.map.layer["modelmaker_sfincs_hmt"].layer["neumann_boundary_polygon_snapwave"].crs = app.crs
    app.map.layer["modelmaker_sfincs_hmt"].layer["neumann_boundary_polygon_snapwave"].draw()
...
def delete_neumann_boundary_polygon_snapwave(*args):
    if len(app.toolbox["modelmaker_sfincs_hmt"].neumann_boundary_polygon_snapwave) == 0:
        return
    index = app.gui.getvar("modelmaker_sfincs_hmt", "neumann_boundary_polygon_index_snapwave")
    # Delete from map
...
def load_neumann_boundary_polygon_snapwave(*args):
    ...
    if not full_name:
        return
    append = False
    if app.gui.getvar("modelmaker_sfincs_hmt", "nr_neumann_boundary_polygons_snapwave"):
...
def select_neumann_boundary_polygon_snapwave(*args):
    index = args[0]
    app.map.layer["modelmaker_sfincs_hmt"].layer["neumann_boundary_polygon_snapwave"].activate_feature(index)
...
def update():
    ...
    app.gui.setvar("modelmaker_sfincs_hmt", "nr_open_boundary_polygons_snapwave", nrp)
    app.gui.setvar("modelmaker_sfincs_hmt", "open_boundary_polygon_names_snapwave", names)
    index = app.gui.getvar("modelmaker_sfincs_hmt", "open_boundary_polygon_index_snapwave")
    if index > nrp - 1:
        index = max(nrp - 1, 0)
    app.gui.setvar("modelmaker_sfincs_hmt", "open_boundary_polygon_index_snapwave", index)
    ...
    for ip in range(nrp):
        names.append(str(ip + 1))
    app.gui.setvar("modelmaker_sfincs_hmt", "nr_neumann_boundary_polygons_snapwave", nrp)
    app.gui.setvar("modelmaker_sfincs_hmt", "neumann_boundary_polygon_names_snapwave", names)
    index = app.gui.getvar("modelmaker_sfincs_hmt", "neumann_boundary_polygon_index_snapwave")
    if index > nrp - 1:
        index = max(nrp - 1, 0)
    app.gui.setvar("modelmaker_sfincs_hmt", "neumann_boundary_polygon_index_snapwave", index)
