...
def delete_refinement_polygon(*args):
    ...
    app.toolbox[_TB].refinement_polygon = app.toolbox[_TB].refinement_polygon.drop(index)
    if len(app.toolbox[_TB].refinement_polygon) > 0:
        app.toolbox[_TB].refinement_polygon = app.toolbox[_TB].refinement_polygon.reset_index(drop=True)
...
def edit_zmin_zmax(*args):
    index = app.gui.getvar(_TB, "refinement_polygon_index")
    app.toolbox[_TB].refinement_polygon.at[index, "zmin"] = app.gui.getvar(_TB, "refinement_polygon_zmin")
    app.toolbox[_TB].refinement_polygon.at[index, "zmax"] = app.gui.getvar(_TB, "refinement_polygon_zmax")
    update()
